	...
	<div class="">
		<div class="modal-body">
			...
			<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
<?php
$sql="SELECT * FROM c_confirm_order WHERE d_boy_id=''";
$i=0;
...
{	
	...
	?><tr>
		...
		<th style="width:10%"><a href="all_order.php?co_id=<?php echo $record['co_id'];?>"><button class="btn btn-danger">Get Order</button></a></th>
