	...
	<div class="thumbnail">
		<div class="modal-body">
			...
			<table id="cart" class="table table-hover table-condensed">
					...
					<tbody>
<?php
$where=$_SESSION['rest_rid'];
$sql="SELECT * FROM c_confirm_order WHERE rest_id='$where' AND delivery_status=''";
$i=0;
...
while($record=mysqli_fetch_array($result))
{
	...
	?><tr>
		...
		<th style="width:10%"><a href="rest_order.php?order_id=<?php echo $record['co_id'];?>"><button class="btn btn-danger">Cancel</button></a></th>
