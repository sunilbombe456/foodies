...
<div class="modal-dialog">
	<div class="thumbnail">
		<div class="modal-body">
			<h3 class="text-center"><strong>Completed Order</strong></h3>
...
$sql="SELECT * FROM c_confirm_order WHERE user_id='$where' AND delivery_status='success'";
$i=0;
...
while($record=mysqli_fetch_array($result))
{
	...
	?><tr>
		...
		<th style="width:10%"><a href="c_user_order.php?order_id=<?php echo $record['co_id'];?>"><button class="btn btn-danger">Delete Order</button></a></th>
